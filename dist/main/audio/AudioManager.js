...
class AudioManager extends events_1.EventEmitter {
    constructor() {
        ...
        this.SAMPLE_RATE = 16000; // Whisper prefers 16kHz
        this.SILENCE_THRESHOLD = 0.01; // Adjust based on environment
        this.SILENCE_DURATION = 1500; // 1.5 seconds of silence
        this.MAX_RECORDING_DURATION = 30000; // 30 seconds max per chunk
        // State tracking
        this.audioBuffer = [];
